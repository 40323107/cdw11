...
ag1_40323107_cdw12_5 = Blueprint('ag1_40323107_cdw12_5', __name__, url_prefix='/ag1_40323107_cdw12_5', template_folder='templates')

# 展示傳回 Brython 程式
@ag1_40323107_cdw12_5.route('/5')
def task1():
    outstring = '''
<!DOCTYPE html>
<html>
