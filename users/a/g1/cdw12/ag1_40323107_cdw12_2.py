...
ag1_40323107_cdw12_2 = Blueprint('ag1_40323107_cdw12_2', __name__, url_prefix='/ag1_40323107_cdw12_2', template_folder='templates')

# 展示傳回 Brython 程式
@ag1_40323107_cdw12_2.route('/4a')
def task1():
    outstring = '''
<!DOCTYPE html>
<html>
