...
ag1_40323107_cdw12_4 = Blueprint('ag1_40323107_cdw12_4', __name__, url_prefix='/ag1_40323107_cdw12_4', template_folder='templates')

# 展示傳回 Brython 程式
@ag1_40323107_cdw12_4.route('/4')
def task1():
    outstring = '''
<!DOCTYPE html>
<html>
