...
ag1_40323107_cdw13 = Blueprint('ag1_40323107_cdw13', __name__, url_prefix='/ag1_40323107_cdw13', template_folder='templates')
...
@ag1_40323107_cdw13.route('/circle')
def drawcircle():
    return head_str + chain_str + circle(0, 0) + tail_str
 
 
@ag1_40323107_cdw13.route('/circle1/<degree>', defaults={'x': 0, 'y': 0})
@ag1_40323107_cdw13.route('/circle1/<x>/<degree>', defaults={'y': 0})
@ag1_40323107_cdw13.route('/circle1/<x>/<y>/<degree>')
#@ag1_40323107_cdw13.route('/circle1/<int:x>/<int:y>/<int:degree>')
def drawcircle1(x,y,degree):
    return head_str + chain_str + circle1(int(x), int(y), int(degree)) + tail_str
 
 
@ag1_40323107_cdw13.route('/circle2/<degree>', defaults={'x': 0, 'y': 0})
@ag1_40323107_cdw13.route('/circle2/<x>/<degree>', defaults={'y': 0})
@ag1_40323107_cdw13.route('/circle2/<x>/<y>/<degree>')
#@ag1_40323107_cdw13.route('/circle2/<int:x>/<int:y>/<int:degree>')
def drawcircle2(x,y,degree):
    return head_str + chain_str + circle2(int(x), int(y), int(degree)) + tail_str
 
 
@ag1_40323107_cdw13.route('/twocircle/<x>/<y>')
@ag1_40323107_cdw13.route('/twocircle', defaults={'x':0, 'y':0})
def drawtwocircle(x,y):
    return head_str + chain_str + twocircle(int(x), int(y)) + tail_str
 
 
@ag1_40323107_cdw13.route('/eighteenthirty/<x>/<y>')
@ag1_40323107_cdw13.route('/eighteenthirty', defaults={'x':0, 'y':0})
def draweithteenthirdy(x,y):
    return head_str + chain_str + eighteenthirty(int(x), int(y)) + tail_str
 
 
@ag1_40323107_cdw13.route('/snap')
...
@ag1_40323107_cdw13.route('/snap_link')
...
@ag1_40323107_cdw13.route('/snap_gear')
def snap_gear():
    outstring = '''
<!DOCTYPE html>
<html>
